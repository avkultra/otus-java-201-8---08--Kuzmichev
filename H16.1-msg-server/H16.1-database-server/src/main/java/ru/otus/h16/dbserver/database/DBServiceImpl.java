...
import ru.otus.h16.dbserver.dao.UserDataSetDAO;
import ru.otus.h16.dbserver.dao.AddressDataSetDAO;
import ru.otus.h16.dbserver.dao.PhoneDataSetDAO;
...
import ru.otus.h16.dbserver.cache.CacheEntry;

import ru.otus.h16.messageserver.messageSystem.Address;
...
public class DBServiceImpl implements DBService, Addressee {
    ...
    public DBServiceImpl(String address, CacheEngine cache) {
    ...
    public DBServiceImpl( String address,  CacheEngine cache, Configuration configuration) {
        this.cache = cache;
